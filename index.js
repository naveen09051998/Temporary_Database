...
submit.addEventListener("click",function(e){
   ...
   // console.log(food)
    ...
    createTable(fname.value,lname.value,address.join(" "),pin.value,genderValue.value,result,state.value,country.value)
    fname.value = ""
    lname.value = ""
    address1.value = ""
    address2.value = ""
...
//createTable(fname,lname,address,pincode,gender,food,state,country);
